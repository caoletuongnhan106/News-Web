    ...
    async create(pk, data) {
        ...
        const params = {
            ...
            Item: {
                ...
                // AI Contradiction Detection Fields
                ContradictionType: data.ContradictionType || 'No-Contradiction',
                ContradictionConfidence: data.ContradictionConfidence || 0,
                ContradictionReason: data.ContradictionReason || ''
            },
        };
