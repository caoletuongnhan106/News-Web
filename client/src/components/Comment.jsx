...
import {baseImageUrl, userRequest} from '../requestMethods';
...
const Comment = ({
    ...
    const handleCheckAI = async () => {
        setAnalyzing(true);
        try {
            const response = await userRequest.post('/ai/analyze-comment', {
            ...
            alert('Failed to analyze comment. Please try again.');
        } finally {
            setAnalyzing(false);
        }
    };
                            ...
                            <div className="comment-content">
                                ...
                                <div className="comment-open">
                                    <button 
                                        ...
                                        disabled={analyzing}
                                        className="btn-action btn-ai-check"
                                        data-tip={analyzing ? "Analyzing..." : "Check for contradictions with AI"}
                                    >
                                        {analyzing ? '⏳ Analyzing...' : '🔍 Check AI'}
                                    </button>
